...
return d}var e={init:function(){var b=$("<div></div>",{"class":a.titleCls});b.append($("<label></label>"));b.append($("<a></a>"));var c=$("<div></div>",{"class":a.contentCls}),d=$("<div></div>",{"class":a.bottomCls});d.append($("<div></div>",{"class":a.tipCls}));$(a.con).css({position:"absolute",display:"none","z-index":10001,top:g(a.top),left:g(a.left),width:g(a.width),height:g(a.height)}).addClass(a.holderCls).html(b).append(c).append(d).find("."+a.titleCls+" a").click(p);$("body").append($("<div></div>",
...
a.contentCls).empty();return e},lock:function(){$(a.con+" input, "+a.con+" textarea").attr("disabled","disabled");h=!0;return e},unlock:s,size:function(b,c,d,k,i,f){if(h)return e;$.isArray(b)&&(c=b[1],d=b[2],k=b[3],i=b[4],f=b[5],b=b[0]);a.width=null==b?a.width:b;a.height=null==c?a.height:c;a.top=null==d?a.top:d;a.left=null==k?a.left:k;null==f&&(f=s);null==i?($(a.con).css({width:g(a.width),height:g(a.height),top:g(a.top),left:g(a.left)}),f.call(this)):(0==a.height&&(_temp=$(a.con).clone().appendTo($(a.con).parent()).css("height",
"auto"),a.height=_temp.height(),_temp.detach()),$(a.con).animate({width:g(a.width,"width"),height:g(a.height,"height"),top:g(a.top,"top"),left:g(a.left,"left")},i,f));return e}},a={con:"#dialog",bg:"background",holderCls:"dialog",titleCls:"dialog-title",contentCls:"dialog-content",barCls:"dialog-bar",bottomCls:"dialog-bottom",buttonCls:"dialog-button",tipCls:"dialog-tip",unselectCls:"unselect",bgClose:!0,drag:!0,width:360,height:0,top:150,left:0.5},o=0,h=!1;switch(typeof n){case "number":a.top=n;
break;case "string":a.con=n;break;case "object":a=$.extend(a,n)}return e}})();
